namespace Illusion
{
  partial class IllusionForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      btn_Load.Location = new Point(2336, 1235);
      ...
      btn_Reload.Location = new Point(2183, 1235);
      ...
      tpVisualization.Size = new Size(1435, 1144);
      ...
      pb_Visualization.Location = new Point(-37, 83);
      ...
      tpStats.Size = new Size(1435, 1144);
      tpStats.TabIndex = 0;
      tpStats.Text = "Stats";
      ...
      dgv_Stats.Size = new Size(1423, 1128);
      ...
      // tb_Errors
      // 
      tb_Errors.Dock = DockStyle.Fill;
      tb_Errors.Location = new Point(6, 8);
      tb_Errors.Multiline = true;
      tb_Errors.Name = "tb_Errors";
      tb_Errors.ReadOnly = true;
      tb_Errors.Size = new Size(1423, 1128);
      tb_Errors.TabIndex = 0;
      // 
      // IllusionForm
      // 
