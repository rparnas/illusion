...
namespace Illusion
{
  public partial class IllusionForm : Form
  {
    ...
    static readonly List<Stat<Group<Block>>> Stats = new List<Stat<Group<Block>>>
    {
      ...
      // new Stat<Block>("Inspections",                     b => b.Inspections.Count()                                                  ),
      // new Stat<Block>("Inspection Findings",             b => b.Inspections.Sum(i => i.Findings)                                     ),
      // new Stat<Block>("Inspection Dev Hours",            b => b.Inspections.Sum(i => i.DevHours)                                     ),
      // new Stat<Block>("Inspection Findings / Dev Hours", b => b.Inspections.Sum(i => i.Findings) / g.Inspections.Sum(i => i.DevHours))
    };
